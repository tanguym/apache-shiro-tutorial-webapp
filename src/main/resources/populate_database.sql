...
insert into shiro_configuration (parameter_key,parameter_value) values ('PASSWORD_MAX_LENGTH','15');
insert into shiro_configuration (parameter_key,parameter_value) values ('PASSWORD_MIN_LENGTH','6');
insert into shiro_configuration (parameter_key,parameter_value) values ('PASSWORD_VALID_CHARACTERS','[\x21-\x7E]*');
insert into shiro_configuration (parameter_key,parameter_value) values ('PASSWORD_COMPLEXITY_RULE','.*[A-Z].*');
insert into shiro_configuration (parameter_key,parameter_value) values ('PASSWORD_COMPLEXITY_RULE','.*[a-z].*');
insert into shiro_configuration (parameter_key,parameter_value) values ('PASSWORD_COMPLEXITY_RULE','.*[0-9].*');
insert into shiro_configuration (parameter_key,parameter_value) values ('PASSWORD_COMPLEXITY_RULE','.*[\W_].*');
insert into shiro_configuration (parameter_key,parameter_value) values ('PASSWORD_MINIMUM_COMPLEXITY','3');
